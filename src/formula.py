...
def homogeneous_mttdl_formula(n: int, k: int, failure_rate: float, repair_rate: float) -> float:
...
def _test_homogeneous_mttdl_formula():
    ...
    repair_rate = 4.
    homogeneous_mttdl = homogeneous_mttdl_formula(
        n, k, failure_rate, repair_rate)
